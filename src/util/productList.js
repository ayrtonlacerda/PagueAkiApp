...
module.export = [
  {
    ...
    infos: [
      [
        ...
        'Fazendo o pagamento por meio do próprio banco emissor do cartão ou Pela utilização de aplicativos através de carteiras digitais, comumento chamadas de "fintechs".',
  ...
  },
  {
    ...
    infos: [
      [
        'Os caminhoneiros são os maiores e principais responsáveis pelo transporte das matérias primas e produtos manufaturados no Brasil! Trata-se de uma atividade que até hoje sofre com total desvalorização e falta de reconhecimento, além de condições de trabalho precárias. Até o ano de 2012 a profissão de motorista de caminhão não era regulamentada.',
        'A partir da organização do trabalho peculiar a profissão e das demandas sociais acerca do excessivo tempo de trabalho desses profissionais, em 2015 entrou em vigor a Lei Nº 13.103 com a finalidade de resguardar os caminhoneiros e produzir bem-estar físico, social e econômico.',
        'Segundo dados apurados durante a greve de 2018, o Brasil tem cerca de 2 milhões de caminhões em atividade, num excesso de 300.000 caminhões.',
      ],
      [
        'São muitos profissionais com uma “carga” de tão elevada importância que merecem serem assistidos de forma digna e reconhecível. ',
        'Por isso que o Instituto de Seguro Solidário, pensando na categoria, desenvolveu em parceria com um grupo de seguradoras, um seguro único, que vai de encontro com as necessidades e prioridades da profissão.',
        'A tabela na próxima página representa a relação de cobertura. Valor em R$.',
      ],
      ['TABELA'],
      [
        'O Instituto de Seguro Solidário, empresa voltada às atividades de associações de defesa de direitos sociais, é uma ferramenta de estudos e pesquisas de diversas categorias profissionais, cujo objetivo é apresentar as melhores soluções para alguns segmentos que considera como prioritários e essenciais no funcionamento do país.',
        'Estudando a categoria “Caminhoneiros”, suas necessidades e dificuldades, formatou um desenho de seguro como nenhum outro, reconhecendo e ofertando efetivamente o que é de direito dessa classe trabalhadora, sem fórmulas mágicas e produtos coloridos: o ISS foi direto ao assunto e formatou “o seguro caminhoneiro” como deve ser feito e ponto!',
        'O seguro prever assistência psicologica, assistência odontológica, assistência proteção pessoal, assistência medicamentos, assistência funeral, dentre outras coberturas. Nas próximas páginas demonstramos as principais coberturas.',
      ],
      [
        'Morte Acidental: Garantir o pagamento de uma indenização ao(s) Beneficiário(s), na ocorrência de morte do Segurado em consequência de acidente pessoal coberto, durante a vigência deste Seguro. Capital Segurado: será uniforme de R$ 60.000,00 (sessenta mil reais) a ser pago em caso de sinistro coberto.',
        'Invalidez Permanente Total ou Parcial por Acidente: Garantir uma indenização ao Segurado, relativa à perda, à redução ou à impotência funcional definitiva, total ou parcial, de um membro ou órgão por lesão física, causada por acidente pessoal coberto. Capital Segurado: será de até R$ 60.000,00 (sessenta mil reais) a ser pago em caso de sinistro coberto',
        'Despesas Médicas Hospitalares e Odontológicas: Garante ao segurado o reembolso, limitado a R$ 5.000,00 (cinco mil reais), das despesas médicas, hospitalares e odontológicas decorrentes exclusivamente de acidentes pessoais não considerados como riscos excluídos e ocorridos durante a vigência do seguro.',
      ],
      [
        'Diária por Incapacidade Temporária decorrente de Acidente e Doença: Garante o pagamento de até 15 (quinze) diárias de R$ 150,00 (cento e cinquenta reais) ao segurado – já aplicados o valor da franquia da cobertura, durante o período em que se verificar sua incapacidade temporária decorrente exclusivamente de acidente e/ou Doença que não seja considerado um risco excluído, ocorrido durante o período de vigência do seguro, e o limite máximo de diárias estabelecido por evento. Para essa cobertura considerar-se-á carência de 60 dias para doença e franquia de 15 dias para doença/acidente. ',
        'Diária por Internação Hospitalar: Garante o pagamento de até 30 (trinta) Diárias Pecuniárias Anuais ao segurado titular, no valor de R$ 800,00 (oitocentos reais) por diária, sendo limitado ao capital máximo de R$ 12.000,00 (doze mil reais) – já aplicados o valor da franquia da cobertura, por vigência anual da apólice, em caso de internação hospitalar para tratamento clínico ou cirúrgico em consequência de doença ou acidente, exceto se decorrente de riscos excluídos. ',
      ],
      [
        'Venha fazer parte desse grupo, preencha o formulário de adesão, escolha sua forma de pagamento e passe a ter verdadeiramente a segurança que lhe é de direito.',
      ],
    ],
    value: 'CAMINHAO',
  },
